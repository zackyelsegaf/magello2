...
use App\Http\Controllers\ModulUtama\Penjualan\PenawaranPenjualanController;
use App\Http\Controllers\ModulUtama\Penjualan\PesananPenjualanController;
use App\Http\Controllers\ModulUtama\Penjualan\PengirimanPenjualanController;
use App\Http\Controllers\ModulUtama\Penjualan\FakturPenjualanController;
use App\Http\Controllers\ModulUtama\Penjualan\FakturPenagihanController;
use App\Http\Controllers\ModulUtama\Penjualan\PenerimaanPenjualanController;
use App\Http\Controllers\ModulUtama\Penjualan\ReturPenjualanController;
...
Route::prefix('modulutama')->group(function () {
    ...
    Route::prefix('penjualan')->group(function () {
        ...
        Route::prefix('penawaran')->controller(PenawaranPenjualanController::class)->group(function () {
        ...
        Route::prefix('pesanan')->controller(PesananPenjualanController::class)->group(function () {
        ...
        Route::prefix('pengiriman')->controller(PengirimanPenjualanController::class)->group(function () {
        ...
        Route::prefix('faktur-penjualan')->controller(FakturPenjualanController::class)->group(function () {
        ...
        Route::prefix('penerimaan')->controller(PenerimaanPenjualanController::class)->group(function () {
        ...
        Route::prefix('retur')->controller(ReturPenjualanController::class)->group(function () {
