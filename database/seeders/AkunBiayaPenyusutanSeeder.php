...
class AkunBiayaPenyusutanSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        // ID tipe akun yang ingin dimasukkan (nama-nama tergantung isi tabel `tipe_akuns`)
        $targetTipe = [
        ...
        // Ambil ID tipe dari nama
        $tipeMap = TipeAkun::whereIn('nama', $targetTipe)->pluck('id', 'nama');

        // Ambil akun-akun berdasarkan tipe_id yang sesuai
        $akuns = Akun::whereIn('tipe_id', $tipeMap->values())->get();
