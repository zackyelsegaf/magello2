    ...
    <div class="content container-fluid">
        <div class="page-header">
            <div class="row align-items-center">
                <div class="col">
                    <div class="mt-5">
                        <h4 class="card-title float-left mt-2">Data Pembayaran Lainnya</h4>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="col-md-3">
                <div class="card rounded-default p-3 bg-dark text-white">
                    <div class="form-group">
                        ...
                        <input type="text" name="no_pembayaran" class="form-control key-filter" placeholder="No. Pembayaran">
                    </div> 
                    <div class="form-group">
            ...
            <div class="col-md-9">
                ...
                <div class="page-header">
                    <div class="mb-15 row align-items-center">
                        <div class="col">
                            <a href="{{ route('pembayaranlainnya/add/new') }}" class="btn btn-primary float-left veiwbutton"><i class="fas fa-plus mr-2"></i>Tambah</a>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            var table = $('#AkunList').DataTable({
                ...
                searching: false,
                ajax: {
                    url: "{{ route('get-pembayaranlainnya-data') }}",
                    data: function(d) {
                ...
                buttons: [
                    {
                        ...
                        title: 'Daftar Pembayaran Lainnya',
                        exportOptions: {
            ...
            $('#deleteSelected').on('click', function() {
                ...
                if (selectedIds.length > 0) {
                    if (confirm('Apakah yakin ingin menghapus data yang dipilih?')) {
                        $.ajax({
                            url: "{{ route('pembayaranlainnya/delete') }}",
                            type: "POST",
                            data: {
                                ids: selectedIds,
                                _token: "{{ csrf_token() }}"
            ...
            $('#AkunList tbody').on('click', 'tr', function(e) {
                ...
                var data = table.row(this).data();
                    if (data) {
                        window.location.href = "/pembayaranlainnya/edit/" + data.id;
                    }
            });
        });
    </script>
