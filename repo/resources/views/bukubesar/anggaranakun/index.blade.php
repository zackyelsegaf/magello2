    ...
    <div class="content container-fluid">
        <div class="page-header">
            <div class="row align-items-center">
                <div class="col">
                    <div class="mt-5">
                        <h4 class="card-title float-left mt-2">Data Anggaran Akun</h4>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="col-md-3">
                <div class="card rounded-default p-3 bg-dark text-white">
                    ...
                    <div class="form-group">
                        ...
                        <div class="row align-items-center">
                            <div class="col-6">
                                <input type="number" name="tahun" class="form-control key-filter" placeholder="Tahun">
                            </div>
                            <div class="col-6">
                                <div class="form-check">
                                    <input class="form-check-input click-filter" style="margin-top: 6px;" id="semua_tahun" type="checkbox" name="semua_tahun" value="1">
                                    <label class="form-check-label" for="semua_tahun">Semua</label>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-md-9">
                ...
                <div class="page-header">
                    <div class="mb-15 row align-items-center">
                        <div class="col">
                            <a href="{{ route('anggaranakun/add/new') }}" class="btn btn-primary float-left veiwbutton"><i class="fas fa-plus mr-2"></i>Tambah</a>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $('#deleteSelected').on('click', function() {
                var selectedIds = $('.anggaran_checkbox:checked').map(function() {
                    return $(this).val();
                }).get();
            ...
            $('#AkunList tbody').on('click', 'tr', function(e) {
                ...
                var data = table.row(this).data();
                    if (data) {
                        window.location.href = "/anggaranakun/edit/" + data.id;
                    }
            });
        });
    </script>
