    ...
    <div class="content container-fluid">
        <form wire:submit.prevent='save'>
            <div class="page-header mt-5">
                <div class="row">
                    <div class="col-sm-6">
                        <h3 class="page-title mb-3">{{ isset($penerimaanId) ? 'Edit' : 'Tambah' }} Penerimaan Lainnya</h3>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6 col-lg-3 col-xl-2">
                        <label for="inputGmp1" class="form-label mb-1">No. Penerimaan</label>
                        <div class="input-group input-group-sm">
                            <input wire:model='no_penerimaan' type="text" class="form-control" placeholder="Ketik sesuatu..." readonly>
                            <button class="btn btn-outline-secondary btn-sm" type="button" wire:click='refreshKode()'>
                                <i class="fas fa-sync-alt"></i>
                            </button>
                            @foreach ($errors->get('no_penerimaan') as $err)
                                <div class="invalid-feedback">{{ $err }}</div>
                            @endforeach
                        </div>
                    </div>
                    <div class="col-sm-6 col-lg-3 col-xl-2">
                        <label for="inputGmp2" class="form-label mb-1">Tanggal Penerimaan</label>
                        <div class="input-group input-group-sm">
                    ...
                    <div class="col-sm-6 col-lg-3 col-xl-2">
                        ...
                        <div class="input-group input-group-sm">
                            <select wire:model="rancangan" id="rancangan" class="form-control">
                                <option value="Penerimaan Lainnya">PBL/Penerimaan Lainnya</option>
                            </select>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="row">
                                <div class="col-12 col-xl-6">
                                    <div class="form-group">
                                        ...
                                        <select wire:model='diterima_ke_akun_id' class="form-control @error('diterima_ke_akun_id') is-invalid @enderror">
                                            <option value="">-- Pilih --</option>
                                            @foreach ($akun as $d)
                                                <option value="{{ $d->id }}">{{ $d->nama_akun_indonesia }}</option>
                                            @endforeach
                                        </select>
                                        @foreach ($errors->get('diterima_ke_akun_id') as $err)
                                            <div class="invalid-feedback">{{ $err }}</div>
                                        @endforeach
                                    </div>
                                </div>
                ...
                <div class="mb-15 row align-items-center">
                    <div class="col">
                        <div class="">
                            ...
                            <a href="{{ route('penerimaanlainnya/list/page') }}" class="btn btn-primary float-left veiwbutton ml-3"><i class="fas fa-chevron-left mr-2"></i>Batal</a>
                        </div>
                    </div>
                </div>
            </div>
