	...
	<div class="main-wrapper">
		<div class="header">
			...
			<div class="header-left">
				<a href="{{ route('home') }}" class="logo"><strong><span class="logoclass">Easy Accounting 7</span></strong></a>
				<a href="{{ route('home') }}" class="logo logo-small"><strong><span class="logoclass thetext">Easy Accounting 7</span></strong></a>
			</div>
			<ul class="nav user-menu">
				...
				<li class="nav-item dropdown has-arrow">
					<a href="#" class="dropdown-toggle nav-link" data-toggle="dropdown"> 
						<span class="user-img">
							@if (Auth::user()->avatar)
								<img class="rounded-circle" src="{{ asset('../../public/assets/img/' . Auth::user()->avatar) }}" alt="profile_image" style="object-fit: cover; width: 31px; height: 31px;">
							@elseif (Auth::user()->avatar == 0)
								<img class="rounded-circle" src="{{ asset('assets/img/profile.png') }}" alt="profile_image" style="object-fit: cover; width: 31px; height: 31px;">
							@endif
						</span>
					</a>
					<div class="dropdown-menu">
						<div class="user-header">
								@if (Auth::user()->avatar)
                                    <img class="avatar-img rounded-circle" src="{{ asset('../../public/assets/img/' . Auth::user()->avatar) }}" alt="profile_image" style="object-fit: cover; width: 40px; height: 40px;">
                                @elseif (Auth::user()->avatar == 0)
                                    <img class="avatar-img rounded-circle" src="{{ asset('../../assets/img/profile.png') }}" alt="profile_image" style="object-fit: cover; width: 40px; height: 40px;">
                                @endif
								<div class="user-text">
