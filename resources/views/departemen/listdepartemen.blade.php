                ...
                <div class="card rounded-default p-3 bg-dark text-white">
                    <form method="GET" action="{{ route('departemen/list/page') }}">
                        <div class="form-group">
                            ...
                            <input type="text" name="departemen_id" class="form-control" onchange="this.form.submit()" placeholder="Cari berdasarkan ID" value="{{ request('departemen_id') }}">
                        </div> 
                        <div class="form-group">
                            <input type="text" name="nama_departemen" class="form-control" onchange="this.form.submit()" placeholder="Nama Departemen" value="{{ request('nama_departemen') }}">
                        </div>
                        <div class="form-group">
