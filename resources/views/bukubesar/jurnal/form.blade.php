    ...
    <div class="content container-fluid">
        <form wire:submit.prevent='save'>
            <div class="page-header mt-5">
                <div class="row">
                    <div class="col-sm-6">
                        <h3 class="page-title mb-3">Bukti Jurnal Umum</h3>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6 col-lg-3 col-xl-2">
                        <label for="inputGmp1" class="form-label mb-1">No. Jurnal</label>
                        <div class="input-group input-group-sm">
                            <input wire:model='no_jurnal' type="text" class="form-control" placeholder="Ketik sesuatu..." readonly>
                            <button class="btn btn-outline-secondary btn-sm" type="button" wire:click='refreshKode()'>
                                <i class="fas fa-sync-alt"></i>
                            </button>
                            @foreach ($errors->get('no_jurnal') as $err)
                                <div class="invalid-feedback">{{ $err }}</div>
                            @endforeach
                        </div>
                    </div>
                    <div class="col-sm-6 col-lg-3 col-xl-2">
                        <label for="inputGmp2" class="form-label mb-1">Tanggal Jurnal</label>
                        <div class="input-group input-group-sm">
                    ...
                    <div class="col-sm-6 col-lg-3 col-xl-2">
                        ...
                        <div class="input-group input-group-sm">
                            <select wire:model="sumber" id="rancangan" class="form-control">
                                <option value="Jurnal Umum">JU/Jurnal Umum</option>
                            </select>
                        </div>
                    </div>
                </div>
                                            ...
                                            <tr>
                                                ...
                                                <td class="py-0" style="min-width: 200px">
                                                    <div class="input-group input-group-sm">
                                                        ...
                                                        <input type="number" wire:model='detail.{{$i}}.debit' class="form-control">
                                                    </div>
                                                </td>
                                                <td class="py-0" style="min-width: 200px">
                                                    <div class="input-group input-group-sm">
                                                        ...
                                                        <input type="number" wire:model='detail.{{$i}}.kredit' class="form-control">
                                                    </div>
                                                </td>
                ...
                <div class="mb-15 row align-items-center">
                    <div class="col">
                        <div class="">
                            ...
                            <a href="{{ route('jurnal/list/page') }}" class="btn btn-primary float-left veiwbutton ml-2"><i class="fas fa-chevron-left mr-2"></i>Batal</a>
                        </div>
                    </div>
                </div>
            </div>
