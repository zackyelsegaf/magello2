        ...
        <div class="content container-fluid">
            <div class="page-header">
                <div class="row align-items-center">
                    <div class="col">
                        <div class="mt-5">
                            <h4 class="card-title float-left mt-2">Harga Jual</h4>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="card rounded-default p-3 filterBox text-white">
                        <form method="GET" action="">
                            ...
                            <div class="form-group mb-1">
                                ...
                                <label class="mt-3" for="">Tanggal Efektif</label>
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" id="filterTanggalEfektif"
                                        name="filterTanggalEfektif">
                                    <label class="form-check-label" for="filterTanggalEfektif">Filter Tanggal
                                        Efektif</label>

                                    <div class="form-group mb-1 mt-2" id="tanggalEfektifInputs" style="display: none;">
                                        <input type="date" name="tanggal_efektif_mulai">
                                        <input type="date" name="tanggal_efektif_selesai">
                                    </div>
                                </div>
                            </div>
                ...
                <div class="col-md-9">
                    ...
                    <div class="page-header">
                        <div class="mb-15 row align-items-center">
                            <div class="col">
                                <a href="{{ Route('hargajual/add/new') }}"
