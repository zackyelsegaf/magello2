...
@section('content')
    <div class="page-wrapper">
        <div class="content container-fluid">
            ...
            <form action="{{ route('aktivatetap/update', $aktivaTetap->id) }}" id="formRekonsiliasi" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <div class="col-lg-12">
                        <div class="row formtype">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control form-control-sm" name="kode_aktiva" value="{{ $aktivaTetap->kode_aktiva }}">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text"class="form-control form-control-sm @error('deskripsi_aktiva') is-invalid @enderror" name="deskripsi_aktiva" value="{{ $aktivaTetap->deskripsi_aktiva }}">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select class="form-control form-control-sm @error('departemen') is-invalid @enderror" name="departemen">
                                        ...
                                        <option value="{{ $items->nama_departemen }}" {{ old('departemen', $aktivaTetap->departemen) == $items->nama_departemen ? 'selected' : '' }}>{{ $items->nama_departemen }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="date" class="form-control form-control-sm @error('tgl_penggunaan') is-invalid @enderror"name="tgl_penggunaan" value="{{ $aktivaTetap->tgl_penggunaan }}">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label><strong class="text-danger h3 align-middle">*</strong>&nbsp;Tanggal Akuisisi</label>
                                    <input type="date" class="form-control form-control-sm @error('tgl_akuisisi') is-invalid @enderror"name="tgl_akuisisi" value="{{ $aktivaTetap->tgl_akuisisi }}">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div id="detail" class="tab-pane fade show active">
                        <div class="container mt-4">
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-3">
                                    <input id="umurPerkiraan" type="number" name="tahun" class="form-control form-control-sm" placeholder="0" value="{{ $aktivaTetap->tahun }}">
                                    <div class="form-text">Th</div>
                                </div>
                                <div class="col-sm-3">
                                    <input type="number" name="bulan" class="form-control form-control-sm" placeholder="0" value="{{ $aktivaTetap->bulan }}">
                                    <div class="form-text">Bulan</div>
                                </div>
                                <div class="col-sm-3">
                                    <input id="nilaiPenyusutan" type="text" name="depresiasi" class="form-control form-control-sm" placeholder="0" value="{{ $aktivaTetap->depresiasi }}">
                                    <div class="form-text">%</div>
                                </div>
                                <div class="col-sm-3" style="display: none;">
                                    <input type="text" name="umur_perkiraan" class="form-control form-control-sm" placeholder="0" value="{{ $aktivaTetap->umur_perkiraan }}">
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-3">
                                    ...
                                    <option value="{{ $items->nama_penyusutan }}" {{ old('metode_penyusutan', $aktivaTetap->metode_penyusutan) == $items->nama_penyusutan ? 'selected' : '' }}>{{ $items->nama_penyusutan }}</option>
                                    @endforeach
                                </select>
                                </div>
                            </div>
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-3">
                                    ...
                                    <option value="{{ $items->nama_akun_indonesia }}" {{ old('akun_aktiva', $aktivaTetap->akun_aktiva) == $items->nama_akun_indonesia ? 'selected' : '' }}>{{ $items->nama_akun_indonesia }}</option>
                                    @endforeach
                                </select>
                                </div>
                            </div>
                            ...
                            <div class="mb-3 row akun-aktiva-wrapper" style="display: none;">
                                ...
                                <div class="col-sm-3">
                                    ...
                                    <option value="{{ $items->nama_akun_indonesia }}" {{ old('akun_akumulasi', $aktivaTetap->akun_akumulasi) == $items->nama_akun_indonesia ? 'selected' : '' }}>{{ $items->nama_akun_indonesia }}</option>
                                    @endforeach
                                </select>
                                </div>
                            </div>
                            ...
                            <div class="card-body">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-striped table-bordered table-hover table-center mb-0" id="DataBarangAddSatuan">
                                            ...
                                            <tbody id="barangTableBody">
                                                @foreach($aktivaTetap->detail as $index => $detail)
                                                    <tr class="barang-row">
                                                        <td><input style="width: 170px;" type="text" name="no_akun[]" value="{{ $detail->no_akun }}" class="form-control form-control-sm" readonly></td>
                                                        <td><input style="width: 170px;" type="date" name="tanggal[]" value="{{ $detail->tanggal }}" class="form-control form-control-sm"></td>
                                                        <td><input style="width: 170px;" type="text" name="deskripsi[]" value="{{ $detail->deskripsi }}" class="form-control form-control-sm"></td>
                                                        <td><input style="width: 170px;" type="text" name="nilai[]" value="{{ $detail->nilai }}" class="form-control form-control-sm"></td>
                                                        <td>
                                ...
                                <div class="row mt-3">
                                    <div class="col-md-3">
                                        ...
                                        <input type="number" class="form-control form-control-sm text-end" name="biaya_aktiva" value="{{ $aktivaTetap->detail2->biaya_aktiva }}" />
                                    </div>
                                    <div class="col-md-3">
                                        <label>Nilai Penyusutan</label>
                                        <input type="number" class="form-control form-control-sm text-end" name="nilai_penyusutan" value="{{ $aktivaTetap->detail2->nilai_penyusutan }}" />
                                    </div>
                                    <div class="col-md-3">
                                        <label>Nilai Buku</label>
                                        <input type="number" class="form-control form-control-sm text-end" name="nilai_buku" value="{{ $aktivaTetap->detail2->nilai_buku }}" />
                                    </div>
                                    <div class="col-md-3">
                                        <label>Nilai Sisa</label>
                                        <input type="number" class="form-control form-control-sm text-end" name="nilai_sisa" value="{{ $aktivaTetap->detail2->nilai_sisa }}" />
                                    </div>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="row formtype">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    {{-- <label>Memo</label> --}}
                                                    <textarea class="form-control form-control-sm" name="memo">{{ old('memo', $aktivaTetap->detail2->memo) }}</textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
