        ...
        $(document).ready(function() {
            var table = $('#BookingKavlingList').DataTable({
                ...
                columns:  [{ 
                    ...
                    {   data: 'suratPemesananRumah',   
                        name:'suratPemesananRumah',   
                        orderable:false, 
                        searchable:false 
                    },
                    {   data: 'konsumen', 
            ...
            $('#select_all').on('click', function() {
                $('.bookingkavling_checkbox').prop('checked', this.checked);
            });
            ...
            $('#deleteSelected').on('click', function() {
                var selectedIds = $('.bookingkavling_checkbox:checked').map(function() {
                    return $(this).val();
                }).get();
