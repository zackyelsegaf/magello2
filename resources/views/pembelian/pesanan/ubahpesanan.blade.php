...
@section('content')
        ...
        <div class="content container-fluid">
            <div class="page-header">
                <div class="row align-items-center">
                    <div class="col">
                        <h3 class="page-title mt-5">Edit Pesanan Pembelian - <strong>{{ $pesananPembelian->no_pesanan }}</strong> - <span id="statusBadge"></span></h3> 
                    </div>
                </div>
            </div>
            <form action="{{ route('pembelian/pesanan/update', $pesananPembelian->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="col-md-10">
                    <div class="card">
                        <div class="card-body">
                                ...
                                <div class="col-md-2 p-2">
                                    <div class="form-group">
                                        ...
                                        <div class="checkbox-wrapper-4">
                                            ...
                                            <input class="inp-cbx" name="pajak_check" id="pajak_check" type="checkbox" value="1" {{ old('pajak_check', $pesananPembelian->pajak_check) ? 'checked' : '' }}>
                                ...
                                <div class="col-md-3 p-2">
                                    <div class="form-group">
                                        ...
                                        <div class="checkbox-wrapper-4">
                                            ...
                                            <input class="inp-cbx" name="termasuk_pajak_check" id="termasuk_pajak_check" type="checkbox" value="1" {{ old('termasuk_pajak_check', $pesananPembelian->termasuk_pajak_check) ? 'checked' : '' }} disabled>
                                ...
                                <div class="col-md-2 p-2">
                                    <div class="form-group">
                                        ...
                                        <div class="checkbox-wrapper-4">
                                            ...
                                            <input class="inp-cbx" name="tutup_check" id="tutup_check" type="checkbox" value="1" {{ old('tutup_check', $pesananPembelian->tutup_check) ? 'checked' : '' }}>
                                ...
                                <div class="col-md-2 p-2">
                                    <div class="form-group">
                                        ...
                                        <div class="checkbox-wrapper-4">
                                            ...
                                            <input class="inp-cbx" name="disetujui_check" id="disetujui_check" type="checkbox" value="1" {{ old('disetujui_check', $pesananPembelian->disetujui_check) ? 'checked' : '' }}>
                                ...
                                <div class="col-md-3 p-2">
                                    <div class="form-group">
                                        ...
                                        <div class="checkbox-wrapper-4">
                                            ...
                                            <input class="inp-cbx" name="uang_muka_check" id="uang_muka_check" type="checkbox" value="1" {{ old('uang_muka_check', $pesananPembelian->detail2->uang_muka_check) ? 'checked' : '' }}>
                                ...
                                <div class="col-lg-10">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="no_pesanan" name="no_pesanan" value="{{ $pesananPembelian->no_pesanan }}">
                                            </div>
                                        </div>
                                        <div class="col-md-6" id="persetujuan-field" style="display: none;">
                                            <div class="form-group">
                                                <label>No. Persetujuan</label>
                                                <input type="text" class="form-control" name="no_persetujuan" value="{{ $pesananPembelian->no_persetujuan }}" readonly>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="cal-icon">
                                                    <input type="text" class="form-control datetimepicker @error('tgl_pesanan') is-invalid @enderror" name="tgl_pesanan" value="{{ $pesananPembelian->tgl_pesanan }}"> 
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group" style="display: none">
                                            ...
                                            <input type="text" class="form-control" name="pengguna_pesanan" value="{{ $pesananPembelian->pengguna_pesanan }}">
                                        </div> 
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group" style="display: none">
                                            <label>Status</label>
                                            <input type="text" class="form-control" name="status_pesanan" id="status_pesanan" value="{{ $pesananPembelian->status_pesanan }}">
                                        </div> 
                                    </div>
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label>Pemasok</label>
                                                <select id="namaBarangSelect" class="form-control" name="pemasok_pesanan">
                                                    <option {{ old('pemasok_pesanan', $pesananPembelian->pemasok_pesanan) ? '' : 'selected' }} disabled> -- Pilih Pemasok</option>
                                                ...
                                                <select id="noPemasokSelect" class="form-control"  name="no_pemasok" style="display: none">
                                                    <option {{ old('no_pemasok', $pesananPembelian->no_pemasok) ? '' : 'selected' }} disabled></option>
                                                    @foreach ($pemasok as $items )
                                                    <option value="{{ $items->pemasok_id }}" {{ old('no_pemasok', $pesananPembelian->no_pemasok) == $items->pemasok_id ? 'selected' : '' }}>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label>No. CNT</label>
                                                <input type="text" class="form-control" name="no_cnt_pesanan" value="{{ $pesananPembelian->no_cnt_pesanan }}" placeholder="No. CNT">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" name="proyek">
                                                    ...
                                                    @foreach ($proyek as $items)
                                                        <option value="{{ $items->nama_proyek }}" {{ old('proyek', $pesananPembelian->detail2->proyek) == $items->nama_proyek ? 'selected' : '' }}>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control"  name="gudang">
                                                    ...
                                                    <option value="{{ $items->nama_gudang }}" {{ old('gudang', $pesananPembelian->detail2->gudang) == $items->nama_gudang ? 'selected' : '' }}>{{ $items->nama_gudang }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control" name="deskripsi_pesanan" placeholder="Deskripsi">{{ old('deskripsi_pesanan', $pesananPembelian->deskripsi_pesanan) }}</textarea> 
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control"  name="departemen">
                                                    ...
                                                    <option value="{{ $items->nama_departemen }}" {{ old('departemen', $pesananPembelian->detail2->departemen) == $items->nama_departemen ? 'selected' : '' }}>{{ $items->nama_departemen }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-striped table-bordered table-hover table-center mb-0" id="DataBarangAddSatuan">
                                        ...
                                        <tbody id="barangTableBody">
                                            ...
                                            @endphp
                                            @foreach ($pesananPembelian->detail as $index => $detail)
                                                <tr class="barang-row">
                                                    ...
                                                    <td><input style="width: 150px;" type="text" class="form-control form-control-sm" name="kts_pesanan[]" value="{{ $detail->kts_pesanan }}"></td>
                                                    <td><input style="width: 150px;" type="text" class="form-control form-control-sm" name="satuan[]" value="{{ $detail->satuan }}"></td>
                                                    <td><input style="width: 150px;" type="text" class="form-control form-control-sm" name="harga_satuan[]" value="{{ $detail->harga_satuan }}"></td>
                                                    <td><input style="width: 150px;" type="text" class="form-control form-control-sm" name="diskon_barang[]" value="{{ $detail->diskon_barang }}"></td>
                                                    <td><input style="width: 150px;" type="text" class="form-control form-control-sm" name="pajak[]" value="{{ $detail->pajak }}"></td>
                                                    <td><input style="width: 150px;" type="text" class="form-control form-control-sm" name="jumlah_total_harga[]" value="{{ $detail->jumlah_total_harga }}"></td>
                                                    <td><input style="width: 150px;" type="text" class="form-control form-control-sm" name="kts_diterima[]" value="{{ $detail->kts_diterima }}"></td>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6"> 
                                            <div class="form-group">
                                                ...
                                                <textarea id="alamatPemasokInput" class="form-control" name="alamat_pemasok" placeholder="Alamat Pemasok">{{ old('alamat_pemasok', $pesananPembelian->detail2->alamat_pemasok) }}</textarea>
                                            </div>                                       
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <div class="cal-icon">
                                                    <input type="text" class="form-control datetimepicker" name="tgl_ekspektasi" value="{{ $pesananPembelian->detail2->tgl_ekspektasi }}">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group mb-1">
                                                ...
                                                <select name="fob" class="form-control">
                                                    <option {{ old('fob', $pesananPembelian->detail2->fob) ? '' : 'selected' }} disabled>-- Pilih FOB --</option>
                                                    <option value="Shipping Point" {{ old('fob', $pesananPembelian->detail2->fob) == 'Shipping Point' ? 'selected' : '' }}>Shipping Point</option>
                                                    <option value="Destination" {{ old('fob', $pesananPembelian->detail2->fob) == 'Destination' ? 'selected' : '' }}>Destination</option>
                                                </select>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-group mb-1">
                                                ...
                                                <select id="syaratSelect" class="form-control" name="syarat">
                                                    <option {{ old('syarat', $pesananPembelian->detail2->syarat) ? '' : 'selected' }} disabled>-- Pilih Syarat --</option>
                                                    @foreach($syarat as $items)
                                                        <option value="{{ $items->nama }}" {{ old('syarat', $pesananPembelian->detail2->syarat) == $items->nama ? 'selected' : '' }}>{{ $items->nama }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group mb-1">
                                                ...
                                                <input id="nilaiTukarInput" type="text" class="form-control" name="nilai_tukar" value="{{  $pesananPembelian->detail2->nilai_tukar  }}">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                ...
                                <div class="row">
                                    <div class="col-lg-12" id="fileuploads_loop">
                                        @php
                                            $i = 1;
                                        @endphp
                                        @while (!empty($pesananPembelian["fileupload_$i"]))
                                            <div class="row formtype mb-2" id="fieldRow_{{ $i }}">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label for="fileupload_{{ $i }}">File {{ $i }}</label>
                                                        <p><a class="link-opacity-10-hover" href="{{ $pesananPembelian["fileupload_$i"] }}">{{ $pesananPembelian["fileupload_$i"] }}</a></p>
                                                    </div>
                                                </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-10">
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <div class="checkbox-wrapper-4">
                                                        ...
                                                        <input class="inp-cbx" name="tindak_lanjut_check" id="tindak_lanjut_check" type="checkbox" value="1" {{ old('tindak_lanjut_check', $pesananPembelian->tindak_lanjut_check) ? 'checked' : '' }}>
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <div class="checkbox-wrapper-4">
                                                        ...
                                                        <input class="inp-cbx" name="urgent_check" id="urgent_check" type="checkbox" value="1" {{ old('urgent_check', $pesananPembelian->urgent_check) ? 'checked' : '' }}>
                                        ...
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <textarea style="width: 300px; height:100px;" class="form-control" name="deskripsi_1" placeholder="Deskripsi">{{ old('deskripsi_1', $pesananPembelian->deskripsi_1) }}</textarea>
                                                </div>
                                                <div class="form-group">
                                                    <div class="dd"></div>
                                                    <div class="checkbox-wrapper-4">
                                                        <input type="hidden" name="catatan_pemeriksaan_check" value="0">
                                                        <input class="inp-cbx" name="catatan_pemeriksaan_check" id="catatan_pemeriksaan_check" type="checkbox" value="1" {{ old('catatan_pemeriksaan_check', $pesananPembelian->catatan_pemeriksaan_check) ? 'checked' : '' }}>
                                                ...
                                                <div class="form-group">
                                                    <textarea style="width: 300px; height:100px;" class="form-control" name="deskripsi_2" placeholder="Deskripsi">{{ old('deskripsi_2', $pesananPembelian->deskripsi_2) }}</textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div id="uang_muka_form" style="display: none;">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control form-control-sm" name="akun_uang_muka">
                                                    <option {{ old('akun_uang_muka', $pesananPembelian->detail2->akun_uang_muka) ? '' : 'selected' }} disabled> --Pilih Sub-- </option>
                                                    @foreach ($nama_akun as $items )
                                                        <option value="{{ $items->no_akun }}" {{ old('akun_uang_muka', $pesananPembelian->detail2->akun_uang_muka) == $items->no_akun ? 'selected' : '' }}>{{ $items->no_akun .' '. $items->nama_akun_indonesia }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-8">
                                                            <div class="form-group">
                                                                <input type="text" class="form-control form-control-sm" name="uang_muka" value="{{ $pesananPembelian->detail2->uang_muka }}">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-8">
                                                            <div class="form-group">
                                                                <input type="text" class="form-control form-control-sm" name="uang_muka_terpakai" value="{{ $pesananPembelian->detail2->uang_muka_terpakai }}">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            <div class="col-md-8 p-0">
                                                <div class="form-group">
                                                    <input type="text" class="form-control form-control-sm" name="sub_total" value="{{ $pesananPembelian->sub_total }}" readonly>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            ...
                                            <div class="col-md-8 p-0">
                                                <div class="input-group input-group-sm mb-4" style="width: 120px;">
                                                    <input type="number" class="form-control" name="diskon_left" value="{{ $pesananPembelian->diskon_left }}">
                                                    <div class="input-group-append">
                                                        <span class="input-group-text">%</span>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <input type="text" class="form-control form-control-sm" name="total_diskon_right" value="{{ $pesananPembelian->total_diskon_right }}">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row" id="ppnRow" style="display: none;">
                                            ...
                                            <div class="col-md-8 p-0">
                                                <div class="form-group">
                                                    <input type="text" class="form-control form-control-sm" name="ppn_11_persen" id="ppn_11_persen" value="{{ $pesananPembelian->ppn_11_persen }}" readonly>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row" id="pajak2Row" style="display: none;">
                                            ...
                                            <div class="col-md-8 p-0">
                                                <div class="form-group">
                                                    <input type="text" class="form-control form-control-sm" name="pajak_2" value="{{ $pesananPembelian->pajak_2 }}" readonly>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            ...
                                            <div class="col-md-8 p-0">
                                                <div class="form-group">
                                                    <input type="text" class="form-control form-control-sm" name="estimasi_biaya" id="estimasi_biaya" value="{{ $pesananPembelian->estimasi_biaya }}">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            ...
                                            <div class="col-md-8 p-0">
                                                <div class="form-group">
                                                    <input type="text" class="form-control form-control-sm" name="jumlah" id="jumlah" value="{{ $pesananPembelian->jumlah }}" readonly>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="mb-15 row align-items-center">
                        <div class="col">
                            <div class="">
                                ...
                                <a href="{{ route('pembelian/pesanan/list/page') }}" class="btn btn-primary float-left veiwbutton ml-3 mb-5"><i class="fas fa-chevron-left mr-2"></i>Batal</a>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function () {
            ...
            const statusInput = document.getElementById("status_pesanan");
