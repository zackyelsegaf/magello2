                ...
                <div class="card rounded-default p-3 bg-dark text-white">
                    <form method="GET" action="{{ route('pembelian/permintaan/list/page') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="no_permintaan" class="form-control" onchange="this.form.submit()" placeholder="Cari berdasarkan ID" value="{{ request('no_permintaan') }}">
                        </div>
                        <div class="form-group">
                            <input type="text" name="deskripsi_permintaan" class="form-control" onchange="this.form.submit()" placeholder="Deskripsi" value="{{ request('deskripsi_permintaan') }}">
                        </div>   
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="pengguna_permintaan" onchange="this.form.submit()">
