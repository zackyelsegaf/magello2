                ...
                <div class="card rounded-default p-3 bg-dark text-white">
                    <form method="GET" action="{{ route('pemasok/list/page') }}">
                        <div class="form-group">
                            ...
                            <input type="text" name="pemasok_id" class="form-control" onchange="this.form.submit()" placeholder="Cari berdasarkan ID" value="{{ request('pemasok_id') }}">
                        </div> 
                        <div class="form-group">
                            <input type="text" name="nama" class="form-control" onchange="this.form.submit()" placeholder="Nama Pemasok" value="{{ request('nama') }}">
                        </div>
                        <div class="form-group">
                            <label>Mata Uang</label>
                            <select class="form-control" name="mata_uang" onchange="this.form.submit()">
