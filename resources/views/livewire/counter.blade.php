                    ...
                    <div class="d-flex justify-content-between gap-3">
                        ...
                        <div class="d-flex flex-column me-2" style="min-width: 0; flex: 1;">
                            ...
                            <div class="input-group input-group-sm">
                                <input id="inputGmp1" type="text" class="form-control" placeholder="Ketik sesuatu..."
                                    aria-label="No. GMP 1">
                        ...
                        <div class="d-flex flex-column" style="min-width: 0; flex: 1;">
                            ...
                            <div class="input-group input-group-sm">
                                <input id="inputGmp2" type="text" class="form-control" placeholder="Ketik sesuatu..."
                                    aria-label="No. GMP 2">
                                <button class="btn btn-outline-secondary btn-sm" type="button"
                                    onclick="location.reload()">
                                    <i class="fas fa-sync-alt"></i>
...
<tr id="row-barang-${id}" class="barang-row" style="font-size: 12px;">
    ...
    <td><input wire:model="data.0.nama_barang" style="width: 150px; height: 26px; font-size: 12px;" type="text" class="form-control deskripsi-barang-input" name="deskripsi_barang[]" value="${nama}"></td>
