        ...
        <div class="content container-fluid">
            <div class="page-header">
                <div class="row align-items-center">
                    <div class="col">
                        <div class="mt-5">
                            <h4 class="card-title float-left mt-2">Data Pengajuan Bahan Bangunan</h4>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="col-md-9">
                    ...
                    <div class="page-header">
                        <div class="mb-15 row align-items-center">
                            <div class="col">
                                <a href="{{ Route('pengajuanbahanbangunan/add/new') }}" class="btn btn-primary float-left veiwbutton"><i
