...
@section('content')
    <div class="page-wrapper">
        <div class="content container-fluid">
            ...
            <form method="POST" action="{{ route('fasos/update', $updateFasos->id) }}" enctype="multipart/form-data">
                @csrf
                ...
                <div class="row mb-3">
                    <div class="col-md-4">
                        ...
                        <select class="tomselect @error('cluster_id') is-invalid @enderror" name="cluster_id" id="kluster" data-placeholder="Pilih cluster...">
                            ...
                            <option value="{{ $items->id }}" {{ old('cluster_id', $updateFasos->cluster_id) == $items->id ? 'selected' : '' }}>{{ $items->nama_cluster }}</option>
                            @endforeach
                        </select>
                        @error('cluster_id')
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="text" id="tipe_model" name="tipe_model" class="form-control" value="{{ old('tipe_model', $updateFasos->tipe_model) }}" placeholder="Tipe Model" readonly>
                    </div>

                    <div class="col-md-4">
                        <label for="blok" class="form-label fw-bold">Blok</label>
                        <input type="text" id="blok" name="blok_fasos" class="form-control @error('blok_fasos') is-invalid @enderror" value="{{ old('blok_fasos', $updateFasos->blok_fasos) }}" placeholder="Blok">
                        @error('blok_fasos')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="number" id="nomor_unit" name="nomor_unit_fasos" class="form-control @error('nomor_unit_fasos') is-invalid @enderror" value="{{ old('nomor_unit_fasos', $updateFasos) }}" placeholder="Nomor Unit">
                        @error('nomor_unit_fasos')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="number" id="jumlah_lantai" name="jumlah_lantai" class="form-control @error('jumlah_lantai') is-invalid @enderror" value="{{ old('jumlah_lantai', $updateFasos->jumlah_lantai) }}" placeholder="Jumlah Lantai">
                        @error('jumlah_lantai')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="number" id="luas_tanah" name="luas_tanah" class="form-control @error('luas_tanah') is-invalid @enderror" value="{{ old('luas_tanah', $updateFasos->luas_tanah) }}" placeholder="Luas Tanah (m²)">
                        @error('luas_tanah')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="number" id="luas_bangunan" name="luas_bangunan" class="form-control @error('luas_bangunan') is-invalid @enderror" value="{{ old('luas_bangunan', $updateFasos->luas_bangunan) }}" placeholder="Luas Bangunan (m²)">
                    </div>
                    ...
                    <div class="col-md-4">
                        ...
                        <select class="tomselect @error('rap_rab_id') is-invalid @enderror" name="rap_rab_id" id="rap_rab" data-placeholder="Pilih rap & rab...">
                            ...
                            <option value="{{ $items->id }}" {{ old('rap_rab_id', $updateFasos->rap_rab_id) == $items->id ? 'selected' : '' }}>{{ $items->judul_rap }}</option>
                            @endforeach
                        </select>
                        @error('rap_rab_id')
                            <div class="invalid-feedback">{{ $message }}</div>
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="text" id="harga" name="harga_fasos" class="form-control rupiah @error('harga_fasos') is-invalid @enderror" value="{{ old('harga_fasos', $updateFasos->harga_fasos) }}" placeholder="Harga">
                        @error('harga_fasos')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-12">
                        ...
                        <textarea id="spesifikasi" class="form-control @error('spesifikasi') is-invalid @enderror" name="spesifikasi" rows="2">{{ old('spesifikasi', $updateFasos->spesifikasi) }}</textarea>
                        @error('spesifikasi')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="tab-content profile-tab-cont">
                    <div class="profile-menu">
                        <ul class="nav nav-tabs nav-tabs-solid">
                            <li class="nav-item"> 
                                <a class="nav-link active font-weight-bold" data-toggle="tab" href="#rincian">Data Arsip Kavling {{ $detail->blok_fasos . "-" . $detail->nomor_unit_fasos . "/" . $detail->nama_cluster}}</a> 
                            </li>
                        </ul>
                    </div>
                ...
                <div class="mb-4 row align-items-center">
                    <div class="col">
                        <a href="{{ route('fasos/list/page') }}" class="btn btn-primary mr-2 buttonedit">
