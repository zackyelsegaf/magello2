        ...
        <div class="content container-fluid">
            <div class="page-header">
                <div class="row align-items-center">
                    <div class="col">
                        <h3 class="page-title mt-5">Tambah Fasos</h3>
                    </div>
                </div>
            </div>

            {{-- Formulir penyimpanan --}}
            <form method="POST" action="{{ route('form/fasos/save') }}" enctype="multipart/form-data">
                @csrf
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="text" id="tipe_model" name="tipe_model" class="form-control" value="Fasos" placeholder="Tipe Model" readonly>
                    </div>

                    <div class="col-md-4">
                        <label for="blok" class="form-label fw-bold">Blok</label>
                        <input type="text" id="blok" name="blok_fasos" class="form-control @error('blok_fasos') is-invalid @enderror" value="{{ old('blok_fasos') }}" placeholder="Blok">
                        @error('blok_fasos')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="number" id="nomor_unit" name="nomor_unit_fasos" class="form-control @error('nomor_unit_fasos') is-invalid @enderror" value="{{ old('nomor_unit_fasos') }}" placeholder="Nomor Unit">
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="text" id="harga" name="harga_fasos" class="form-control rupiah @error('harga_fasos') is-invalid @enderror" value="{{ old('harga_fasos') }}" placeholder="Harga">
                        @error('harga_fasos')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
