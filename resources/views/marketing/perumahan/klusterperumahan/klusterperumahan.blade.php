    ...
    <div class="content container-fluid">
        <div class="page-header">
            <div class="row align-items-center">
                <div class="col">
                    <div class="mt-5">
                        <h4 class="card-title float-left mt-2">Kluster / Perumahan</h4>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="col-md-3">
                <div class="card rounded-default p-3 filterBox text-white">
                    <div class="form-group">
                        ...
                        <input type="text" name="nama_cluster" class="form-control form-control-sm key-filter" placeholder="Nama Cluster">
                    </div>
                </div>
            </div>
            <div class="col-md-9">
                ...
                <div class="page-header">
                    <div class="mb-15 row align-items-center">
                        <div class="col">
                            <a href="{{ route('klusterperumahan/add/new') }}" class="btn btn-primary float-left veiwbutton"><i class="fas fa-plus mr-2"></i>Tambah</a>
        ...
        $(document).ready(function() {
            ...
            $('#deleteSelected').on('click', function() {
                ...
                if (selectedIds.length > 0) {
                    if (confirm('Apakah yakin ingin menghapus data yang dipilih?')) {
                        $.ajax({
                            url: "{{ route('klusterperumahan/delete') }}",
                            type: "POST",
                            data: {
                                ids: selectedIds,
                                _token: "{{ csrf_token() }}"
            ...
            $('#ClusterList tbody').on('click', 'tr', function(e) {
                ...
                var data = table.row(this).data();
                    if (data) {
                        window.location.href = "/klusterperumahan/edit/" + data.id;
                    }
            });
        });
    </script>
