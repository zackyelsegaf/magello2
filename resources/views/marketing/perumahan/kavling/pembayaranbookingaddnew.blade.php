                ...
                <div class="col-md-12 px-3">
                    ...
                    <div class="my-rounded-2">
                        <div class="col-md-12 p-3 bg-white border my-rounded-2">
                            <div id="bk_0_0">
                                <div class="modal fade" id="bk_0_0_0" tabindex="-1" role="dialog" aria-labelledby="modalBookingFee" aria-hidden="true">
                                    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
                                        <div class="modal-content my-rounded-2">
                                            ...
                                            <form method="POST" id="formFilterPembayaran" action="{{ route('booking.pembayaran-booking.pembayaran0.store', ['id' => $detailBooking->id]) }}" enctype="multipart/form-data">
                                                @csrf
                                                @if(isset($edit))
                            ...
                            <div id="bk_1_1">
                                <div class="modal fade" id="bk_1_1_1" tabindex="-1" role="dialog" aria-labelledby="modalBiayaAdministrasi" aria-hidden="true">
                                    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
                                        <div class="modal-content my-rounded-2">
                                            <div class="modal-header">
                                                <h6 class="modal-title font-weight-bold">Tambah Pembayaran Biaya Administrasi</h6>
                                                <button type="button" class="close" data-dismiss="modal">
                                                    <span>&times;</span>
                                                </button>
                                            </div>
                                            <form method="POST" id="formFilterPembayaran" action="{{ route('booking.pembayaran-booking.pembayaran1.store', ['id' => $detailBooking->id]) }}" enctype="multipart/form-data">
                                                @csrf
                                                <div class="modal-body">
                                ...
                                <div class="modal fade" id="bk_2_2_2" tabindex="-1" role="dialog" aria-labelledby="modalBiayaUangMuka" aria-hidden="true">
                                    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
                                        <div class="modal-content my-rounded-2">
                                            ...
                                            <form method="POST" action="{{ route('booking.pembayaran-booking.pembayaran2.store', ['id' => $detailBooking->id]) }}" enctype="multipart/form-data">
                                                @csrf
                                                <div class="modal-body">
                                ...
                                <div class="modal fade" id="bk_3_3_3" tabindex="-1" role="dialog" aria-labelledby="modalBiayaKelebihanTanah" aria-hidden="true">
                                    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
                                        <div class="modal-content my-rounded-2">
                                            ...
                                            <form method="POST" action="{{ route('booking.pembayaran-booking.pembayaran3.store', ['id' => $detailBooking->id]) }}" enctype="multipart/form-data">
                                                @csrf
                                                <div class="modal-body">
                                ...
                                <div class="modal fade" id="bk_4_4_4" tabindex="-1" role="dialog" aria-labelledby="modalBiayaPenambahanBangunan" aria-hidden="true">
                                    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
                                        <div class="modal-content my-rounded-2">
                                            ...
                                            <form method="POST" action="{{ route('booking.pembayaran-booking.pembayaran4.store', ['id' => $detailBooking->id]) }}" enctype="multipart/form-data">
                                                @csrf
                                                <div class="modal-body">
                                ...
                                <div class="modal fade" id="bk_5_5_5" tabindex="-1" role="dialog" aria-labelledby="modalBiayaLainnya" aria-hidden="true">
                                    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
                                        <div class="modal-content my-rounded-2">
                                            ...
                                            <form method="POST" action="{{ route('booking.pembayaran-booking.pembayaran5.store', ['id' => $detailBooking->id]) }}" enctype="multipart/form-data">
                                                @csrf
                                                <div class="modal-body">
                                ...
                                <div class="modal fade" id="bk_6_6_6" tabindex="-1" role="dialog" aria-labelledby="modalTotalPenjualanCash" aria-hidden="true">
                                    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
                                        <div class="modal-content my-rounded-2">
                                            ...
                                            <form method="POST" action="{{ route('booking.pembayaran-booking.pembayaran6.store', ['id' => $detailBooking->id]) }}" enctype="multipart/form-data">
                                                @csrf
                                                <div class="modal-body">
                                ...
                                <div class="modal fade" id="bk_7_7_7" tabindex="-1" role="dialog" aria-labelledby="modalLabelCicilanCash" aria-hidden="true">
                                    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
                                        <div class="modal-content my-rounded-2">
                                            ...
                                            <form method="POST" action="{{ route('booking.pembayaran-booking.pembayaran7.store', ['id' => $detailBooking->id]) }}" enctype="multipart/form-data">
                                                @csrf
                                                <div class="modal-body">
                                ...
                                <div class="modal fade" id="bk_8_8_8" tabindex="-1" role="dialog" aria-labelledby="modalLabelBiayaAkadKredit" aria-hidden="true">
                                    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
                                        <div class="modal-content my-rounded-2">
                                            ...
                                            <form method="POST" action="{{ route('booking.pembayaran-booking.pembayaran8.store', ['id' => $detailBooking->id]) }}" enctype="multipart/form-data">
                                                @csrf
                                                <div class="modal-body">
                                ...
                                <div class="modal fade" id="bk_9_9_9" tabindex="-1" role="dialog" aria-labelledby="modalLabelBiayaPenambahanFasilitas" aria-hidden="true">
                                    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
                                        <div class="modal-content my-rounded-2">
                                            ...
                                            <form method="POST" action="{{ route('booking.pembayaran-booking.pembayaran9.store', ['id' => $detailBooking->id]) }}" enctype="multipart/form-data">
                                                @csrf
                                                <div class="modal-body">
                                ...
                                <div class="modal fade" id="bk_10_10_10" tabindex="-1" role="dialog" aria-labelledby="modalLabelPenerimaanKpr" aria-hidden="true">
                                    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
                                        <div class="modal-content my-rounded-2">
                                            ...
                                            <form method="POST" action="{{ route('booking.pembayaran-booking.pembayaran10.store', ['id' => $detailBooking->id]) }}" enctype="multipart/form-data">
                                                @csrf
                                                <div class="modal-body">
