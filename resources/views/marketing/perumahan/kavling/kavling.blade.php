        ...
        <div class="content container-fluid">
            <div class="page-header">
                <div class="row align-items-center">
                    <div class="col">
                        <div class="mt-5">
                            <h4 class="card-title float-left mt-2">Kavling</h4>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-3">
                    <div class="card rounded-default p-3 filterBox text-white">
                        <form method="GET" action="{{ route('kavling/list/page') }}">
                            <div class="form-group mb-1">
                                <label>Pencarian</label>
                                <input type="text" name="" class="form-control form-control-sm" onchange="this.form.submit()" placeholder="" value="">
                            </div>
                            <div class="form-group mb-1">
                                ...
                                @foreach ($cluster as $items)
                                    <option value="{{ $items->nama_cluster }}" {{ request('cluster') == $items->nama_cluster ? 'selected' : '' }}>
                                        {{ $items->nama_cluster }}
                                    </option>
                                @endforeach
                            </select>
                ...
                <div class="col-md-9">
                    ...
                    <div class="page-header">
                        <div class="mb-15 row align-items-center">
                            <div class="col">
                                <a href="{{ Route('kavling/add/new') }}" class="btn btn-primary float-left veiwbutton"><i
        ...
        $(document).ready(function() {
            var table = $('#DepartemenList').DataTable({
                ...
                columns:  [{
                    ...
                    {
                        data: 'nomor_unit_kapling',
                        name: 'nomor_unit_kapling',
                        orderable: false,
                        searchable: false
                    },
                    {
            ...
            $('#select_all').on('click', function() {
                $('.kavling_checkbox').prop('checked', this.checked);
            });
            ...
            $('#deleteSelected').on('click', function() {
                var selectedIds = $('.kavling_checkbox:checked').map(function() {
                    return $(this).val();
                }).get();
            ...
            $('#DepartemenList tbody').on('click', 'tr', function(e) {
                ...
                var data = table.row(this).data();
                    if (data) {
                        window.location.href = "/kavling/edit/" + data.id;
                    }
            });
        });
    </script>
