            ...
            <form method="POST" action="{{ route('kavling/update', $updateKavling->id) }}" enctype="multipart/form-data">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="text" id="harga" name="harga_kapling" class="form-control rupiah @error('harga_kapling') is-invalid @enderror" value="{{ old('harga_kapling', $updateKavling->harga_kapling) }}" placeholder="Harga">
                        @error('harga_kapling')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
