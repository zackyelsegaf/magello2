                ...
                <div class="row align-items-center mt-5">
                    ...
                    <div class="col">
                        ...
                        @else
                            ...
                            <button class="btn btn-outline-danger buttonedit-outline float-right" disabled>
                                <strong><i class="fas fa-ban mr-2"></i>Sudah dibooking</strong>
                            </button>
                ...
                <div class="row mb-3">
                    <div class="col-md-4">
                        ...
                        <select class="tomselect @error('cluster_id') is-invalid @enderror" name="cluster_id" id="kluster" data-placeholder="Pilih cluster...">
                            ...
                            <option value="{{ $items->id }}" {{ old('cluster_id', $updateKavling->cluster_id) == $items->id ? 'selected' : '' }}>{{ $items->nama_cluster }}</option>
                            @endforeach
                        </select>
                        @error('cluster_id')
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="text" id="tipe_model" name="tipe_model" class="form-control form-control-sm" value="{{ old('tipe_model', $updateKavling->tipe_model) }}" placeholder="Tipe Model" readonly>
                    </div>

                    <div class="col-md-4">
                        <label for="blok" class="form-label fw-bold">Blok</label>
                        <input type="text" id="blok" name="blok_kapling" class="form-control form-control-sm @error('blok_kapling') is-invalid @enderror" value="{{ old('blok_kapling', $updateKavling->blok_kapling) }}" placeholder="Blok">
                        @error('blok_kapling')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="number" id="nomor_unit" name="nomor_unit_kapling" class="form-control form-control-sm @error('nomor_unit_kapling') is-invalid @enderror" value="{{ old('nomor_unit_kapling', $updateKavling) }}" placeholder="Nomor Unit">
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="number" id="jumlah_lantai" name="jumlah_lantai" class="form-control form-control-sm @error('jumlah_lantai') is-invalid @enderror" value="{{ old('jumlah_lantai', $updateKavling->jumlah_lantai) }}" placeholder="Jumlah Lantai">
                        @error('jumlah_lantai')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="number" id="luas_tanah" name="luas_tanah" class="form-control form-control-sm @error('luas_tanah') is-invalid @enderror" value="{{ old('luas_tanah', $updateKavling->luas_tanah) }}" placeholder="Luas Tanah (m²)">
                        @error('luas_tanah')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="number" id="luas_bangunan" name="luas_bangunan" class="form-control form-control-sm @error('luas_bangunan') is-invalid @enderror" value="{{ old('luas_bangunan', $updateKavling->luas_bangunan) }}" placeholder="Luas Bangunan (m²)">
                    </div>
                    ...
                    <div class="col-md-4">
                        ...
                        <select class="tomselect @error('rap_rab_id') is-invalid @enderror" name="rap_rab_id" id="rap_rab" data-placeholder="Pilih rap & rab...">
                            ...
                            <option value="{{ $items->id }}" {{ old('rap_rab_id', $updateKavling->rap_rab_id) == $items->id ? 'selected' : '' }}>{{ $items->judul_rap }}</option>
                            @endforeach
                        </select>
                        @error('rap_rab_id')
                            <div class="invalid-feedback">{{ $message }}</div>
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="text" id="harga" name="harga_kapling" class="form-control form-control-sm rupiah @error('harga_kapling') is-invalid @enderror" value="{{ old('harga_kapling', $updateKavling->harga_kapling) }}" placeholder="Harga">
                        @error('harga_kapling')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-12">
                        ...
                        <textarea id="spesifikasi" class="form-control @error('spesifikasi') is-invalid @enderror" name="spesifikasi" rows="2">{{ old('spesifikasi', $updateKavling->spesifikasi) }}</textarea>
                        @error('spesifikasi')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="tab-content profile-tab-cont">
                    <div class="profile-menu">
                        <ul class="nav nav-tabs nav-tabs-solid">
                            <li class="nav-item"> 
                                <a class="nav-link active font-weight-bold" data-toggle="tab" href="#rincian">Data Arsip Kavling {{ $detail->blok_kapling . "-" . $detail->nomor_unit_kapling . "/" . $detail->nama_cluster}}</a> 
                            </li>
                        </ul>
                    </div>
