...
@section('content')
    <div class="page-wrapper">
        <div class="content container-fluid">
            ...
            <form method="POST" action="{{ route('booking/konsumen/detail', $booking->id) }}" enctype="multipart/form-data">
                @csrf
                ...
                {{-- @if($booking->konsumen->detail)
                    ...
                    <p><strong>Nama Pasangan:</strong> {{ $booking->konsumen->detail->nama_2 ?? '-' }}</p>
                    <p><strong>NIK Pasangan:</strong> {{ $booking->konsumen->detail->nik_2 ?? '-' }}</p>
                    <p><strong>No HP Pasangan:</strong> {{ $booking->konsumen->detail->no_hp_2 ?? '-' }}</p>
                ...
                <div class="mb-4 row align-items-center">
                    <div class="col">
                        ...
                        <a href="{{ route('booking/konsumen/detail/pdf', $booking->id) }}" class="btn btn-primary buttonedit" target="_blank">
