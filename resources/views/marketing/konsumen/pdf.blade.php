...
<body>
    ...
    <div style="padding-bottom: 25px;" class="text-left">No.  {{ $booking->nomor_spr }}</div>
    <div class="isi">
    ...
    <div class="meta" style="margin-top: 0px;">
        <table>
            <tr>
                ...
                <td style="width: 10px;">:</td>
                <td>{{ 'Rp ' . number_format($booking->konsumen->booking_fee ?? 0, 0, '.', ',') ?? '-' }}</td>
            </tr>
            <tr>
    ...
    <table style="width:100%; text-align:center;">
        <tr style="vertical-align: top;">
            ...
            <td>
                <p style="padding-bottom: 0px;">Bandung, {{ $tanggalSppHuman }}</p>
